                ...
                <div class="tab-pane fade pt-3" id="account" role="tabpanel" aria-labelledby="account-tab">
                  <div class="container">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <input type="text"  placeholder="User name" v-model="account.name" class="form-control">
                          </div>
                        </div>

                        <div class="col-md-6">
                          <div class="form-group">
                            <input type="text"   placeholder="Email address" v-model="account.email" class="form-control">
                          </div>
                        </div>

                        <div class="col-md-6">
                          <div class="form-group">
                            <input type="text"  placeholder="New password" v-model="account.password" class="form-control">
                          </div>
                        </div>

                        <div class="col-md-6">
                          <div class="form-group">
                            <input type="text"   placeholder="Confirm password" v-model="account.confirmPassword" class="form-control">
                          </div>
                        </div>
...
export default {
  ...
  props: {
   ...
   data(){
    ...
    //Getting the collection  of currently logged in user 
     firestore () {
  ...
  methods:{
    ...
    resetPassword(){
          const auth =fb.auth();
          fb.auth().sendPasswordResetEmail(auth.currentUser.email)
          .then(() => {
           Swal.fire(
                        'Sent!',
